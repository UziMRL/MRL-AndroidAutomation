...
class Detection_AM_more_then_2_min_ad_Test(unittest.TestCase):
    ...
    @pytest.mark.order(1)
    def test_multi_ads_detections_AM_diff_ads_more_then_2_min_len_2_min_gap(self):
        gap = 120
        play_from = "2_min_and_more_ads"
        ...
        if get_if_KotlinRecord_dir_exist(device_id=self.infoPage.device["device_id"]):
            copy_PCMs(self.infoPage.device["device_id"],
                      self.test_multi_ads_detections_AM_diff_ads_more_then_2_min_len_2_min_gap.__name__)
    ...
    @pytest.mark.order(2)
    def test_multi_ads_detections_AM_diff_ads_more_then_2_min_len_1_min_gap(self):
        gap = 60
        play_from = "2_min_and_more_ads"
        sleep_before_detections = 300
        to_play = get_ads_to_play_from_dir(play_from)
        ...
        if get_if_KotlinRecord_dir_exist(device_id=self.infoPage.device["device_id"]):
            copy_PCMs(self.infoPage.device["device_id"],
                      self.test_multi_ads_detections_AM_diff_ads_more_then_2_min_len_1_min_gap.__name__)
    ...
    @pytest.mark.order(3)
    def test_multi_ads_detections_AM_diff_ads_more_then_2_min_len_30_sec_gap(self):
        gap = 30
        play_from = "2_min_and_more_ads"
        sleep_before_detections = 300
        to_play = get_ads_to_play_from_dir(play_from)
        ...
        if get_if_KotlinRecord_dir_exist(device_id=self.infoPage.device["device_id"]):
            copy_PCMs(self.infoPage.device["device_id"],
                      self.test_multi_ads_detections_AM_diff_ads_more_then_2_min_len_30_sec_gap.__name__)
    ...
    @pytest.mark.order(4)
    def test_multi_ads_detections_AM_diff_ads_more_then_2_min_len_5_sec_gap(self):
        gap = 5
        play_from = "2_min_and_more_ads"
        sleep_before_detections = 300
        to_play = get_ads_to_play_from_dir(play_from)
        ...
        if get_if_KotlinRecord_dir_exist(device_id=self.infoPage.device["device_id"]):
            copy_PCMs(self.infoPage.device["device_id"],
                      self.test_multi_ads_detections_AM_diff_ads_more_then_2_min_len_5_sec_gap.__name__)
    ...
    def test_multi_ads_detections_AM_diff_ads_1_min_len_without_gap(self):
        ...
        if get_if_KotlinRecord_dir_exist(device_id=self.infoPage.device["device_id"]):
            copy_PCMs(self.infoPage.device["device_id"],
                      self.test_multi_ads_detections_AM_diff_ads_1_min_len_without_gap.__name__)
