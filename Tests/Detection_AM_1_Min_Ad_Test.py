...
class Detection_AM_1_Min_Ad_Test(unittest.TestCase):

    # this class test Ads with len of 1 min by gaps
    ...
    def test_multi_ads_detections_AM_diff_ads_1_min_len_2_min_gap(self):
        ...
        if get_if_KotlinRecord_dir_exist(device_id=self.infoPage.device["device_id"]):
            copy_PCMs(self.infoPage.device["device_id"],self.test_multi_ads_detections_AM_diff_ads_1_min_len_2_min_gap.__name__)
    ...
    def test_multi_ads_detections_AM_diff_ads_1_min_len_30_sec_gap(self):
        ...
        if get_if_KotlinRecord_dir_exist(device_id=self.infoPage.device["device_id"]):
            copy_PCMs(self.infoPage.device["device_id"],self.test_multi_ads_detections_AM_diff_ads_1_min_len_30_sec_gap.__name__)
    ...
    def test_multi_ads_detections_AM_diff_ads_1_min_len_5_sec_gap(self):
        ...
        if get_if_KotlinRecord_dir_exist(device_id=self.infoPage.device["device_id"]):
            copy_PCMs(self.infoPage.device["device_id"],self.test_multi_ads_detections_AM_diff_ads_1_min_len_5_sec_gap.__name__)
    ...
    def test_multi_ads_detections_AM_diff_ads_1_min_len_without_gap(self):
        ...
        if get_if_KotlinRecord_dir_exist(device_id=self.infoPage.device["device_id"]):
            copy_PCMs(self.infoPage.device["device_id"],self.test_multi_ads_detections_AM_diff_ads_1_min_len_without_gap.__name__)
